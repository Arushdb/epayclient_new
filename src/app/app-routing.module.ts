...
const routes: Routes = [
  ...
  {
    path: 'applicationfee/:appno',
    component: ApplicationfeeComponent,
    data: { feetype: 'appfee', cat: 'appfee' },
    pathMatch: 'full',
  },
  ...
  {
    path: 'migcertificate',
    component: CertificatefeeComponent,
    data: { certificatetype: 'mig', cat: 'CER' },
  },
  {
    path: 'degcertificate',
    component: CertificatefeeComponent,
    data: { certificatetype: 'deg', cat: 'CER' },
  },
  {
    path: 'trncertificate',
    component: CertificatefeeComponent,
    data: { certificatetype: 'trn', cat: 'CER' },
  },
  {
    path: 'procertificate',
    component: CertificatefeeComponent,
    data: { certificatetype: 'pro', cat: 'CER' },
  },
  {
    path: 'rescertificate',
    component: CertificatefeeComponent,
    data: { certificatetype: 'res', cat: 'CER' },
  },
  { path: 'hostelfee', component: HostelfeeComponent, data: { cat: 'HOS' } },
  // { path: 'postfee/:appno', component: PostfeeComponent, data: { cat: 'POS' } },
  {
    path: 'postfee/:appno',
    component: PostfeeComponent,
    data: { cat: 'POS' },
    pathMatch: 'full',
  },
